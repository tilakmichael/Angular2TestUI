...
export class AppAccDocs implements OnInit{
 ...
 public glid:number ;
 public emptyData= {id:-1,code:null,docno:null,docdate:null,orgid:null,prdid:null,refno:null,refdate:null,describ:null,amount:null,status:null} ;
 public pager:any = {};
...
public onChange(event) {
      ...
      if (this.slcode) {
         this.bookData = this.allData.filter(data =>  data.orgid==this.orgId && data.slcode==this.slcode );
