...
var AppAccDocs = (function () {
    function AppAccDocs(_data, _common, _bldr, _route) {
        ...
        this.slBookData = [];
        this.editFlag = false;
        this.emptyData = { id: -1, code: null, docno: null, docdate: null, orgid: null, prdid: null, refno: null, refdate: null, describ: null, amount: null, status: null };
        this.pager = {};
    }
    ;
    ...
    AppAccDocs.prototype.onChange = function (event) {
        ...
        if (this.slcode) {
            this.bookData = this.allData.filter(function (data) { return data.orgid == _this.orgId && data.slcode == _this.slcode; });
